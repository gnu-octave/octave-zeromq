...
<dt class="deftypefn" id="index-zmq_005fclose"><span class="category-def">: </span><span><strong class="def-name">zmq_close</strong> <code class="def-code-arguments">(<var class="var">sock</var>)</code><a class="copiable-link" href='#index-zmq_005fclose'></a></span></dt>
<dd> 

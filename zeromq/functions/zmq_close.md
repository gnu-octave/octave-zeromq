...
<dt class="deftypefn def-line" id="index-zmq_005fclose"><span><strong class="def-name">zmq_close</strong> <code class="def-code-arguments">(<var class="var">sock</var>)</code></span></dt>
<dd> 
